...
<div class="table_section">
    <table>
        <thead>
            <tr>
                <th><a href="#" class="sort" data-orderby="ID_RECIBO_DETALLE">ID Detalle <i class="fa-solid fa-sort"></i></a></th>
                <th><a href="#" class="sort" data-orderby="FECHA_ENTRADA">fecha entrada <i class="fa-solid fa-sort"></i></a></th>
                <th><a href="#" class="sort" data-orderby="TIPO_EMPAQUE">Tipo de Empaque <i class="fa-solid fa-sort"></i></a></th>
                <th><a href="#" class="sort" data-orderby="NOMBRE_PRODUCTOS">Producto <i class="fa-solid fa-sort"></i></a></th>
        ...
        <tbody>
            <?php foreach ($detalles as $row) : ?>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['FECHA_ENTRADA'], ENT_QUOTES, 'UTF-8'); ?></td>
                    ...
                    <td>
                        ...
                        <a href="#" data-id="<?php echo htmlspecialchars($id_recibo, ENT_QUOTES, 'UTF-8'); ?>&id_detalle=<?php echo htmlspecialchars($row['ID_RECIBO_DETALLE'], ENT_QUOTES, 'UTF-8'); ?>" class="boton-tracking">
