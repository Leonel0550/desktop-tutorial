        ...
        <div class="table_container">
            <div class="table">
                <div class="table_header">
                    <h3>Lista de todas las categorias</h3>
                    <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function openEditModal(id) {
                openModal(editarModal, 'editar_categoria.php?id=' + id);
            }
            ...
            function loadPage(page, orderBy = currentOrderBy, orderDir = currentOrderDir) {
                fetch(`pagination_categoria.php?page=${page}&limit=15&orderBy=${orderBy}&orderDir=${orderDir}`)
                    .then(response => response.text())
                    .then(data => {
